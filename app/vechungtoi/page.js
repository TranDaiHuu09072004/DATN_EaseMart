      ...
      <div className={styles.servicesSection}>
        ...
        <div className={styles.services}>
          <div className={styles.service}>
            ...
            <h3>Giá tốt nhất và ưu đãi</h3>
            <p>EaseMart luôn cung cấp cho khách hàng mức giá cạnh tranh nhất trên thị trường.</p>
          </div>
          <div className={styles.service}>
            <img src="/assets/img/Group 6.png" alt="Sự đa dạng" className={styles.icon} />
            <h3>Sự đa dạng</h3>
            <p>EaseMart cung cấp đầy đủ các mặt hàng thiết yếu cho cuộc sống hằng ngày.</p>
          </div>
          <div className={styles.service}>
