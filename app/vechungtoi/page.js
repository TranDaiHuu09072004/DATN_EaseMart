      ...
      <div className={styles.container}>
        ...
        <div className={styles.introSection}>
          ...
          <div className={styles.textContainer}>
            ...
            <p className={styles.description}>
              EaseMart là chuỗi cửa hàng tiện lợi, chuyên cung cấp các sản phẩm
              hàng tiêu dùng thiết yếu cho cuộc sống hàng ngày với giá cả hợp
              lý. Với phương châm "Tiện lợi mỗi ngày", chúng tôi mong muốn đem
              đến trải nghiệm mua sắm tiện lợi, nhanh chóng và chất lượng cho
              khách hàng.
            </p>
            <div className={styles.imageGroup}>
              <img
                src="/assets/img/vechungtoi2.png"
                alt="Image 2"
                className={styles.subImage}
              />
              <img
                src="/assets/img/vechungtoi3.png"
                alt="Image 3"
                className={styles.subImage}
              />
              <img
                src="/assets/img/vechungtoi4.png"
                alt="Image 4"
                className={styles.subImage}
              />
            </div>
          ...
          <div className={styles.services}>
            <div className={styles.serviceCard}>
              ...
              <p className={styles.serviceDescription}>
                EaseMart luôn cung cấp cho khách hàng mức giá cạnh tranh nhất
                trên thị trường.
              </p>
            </div>
            <div className={styles.serviceCard}>
              ...
              <p className={styles.serviceDescription}>
                EaseMart cung cấp đầy đủ các mặt hàng thiết yếu cho cuộc sống
                hằng ngày.
              </p>
            </div>
            <div className={styles.serviceCard}>
              ...
              <p className={styles.serviceDescription}>
                Giao hàng tận nơi nhanh chóng , cung cấp đầy đủ các mặt hàng
            ...
            <div className={styles.serviceCard}>
              <img
                src="/assets/img/icon-note__money.png"
                alt="100% hài lòng"
                className={styles.icon}
              />
            ...
            <div className={styles.serviceCard}>
              <img
                src="/assets/img/icon-sell 1.png"
        ...
        >
          ...
          <div className={styles.performanceText}>
            ...
            <p>
              Đối tác của bạn cho giải pháp thương mại điện tử EaseMart tự hào
              là đối tác tin cậy cho các giải pháp thương mại điện tử, giúp bạn
              đặt hàng một cách hiệu quả và nhanh chóng. Chúng tôi luôn nỗ lực
              cải thiện hệ thống để mang đến trải nghiệm tốt nhất cho khách
              hàng.
            </p>
          </div>
        </div>
