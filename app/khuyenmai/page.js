    ...
    <div className="container mx-auto px-4">
      <div className={`${styles.container} flex flex-col`}>
        ...
        <div className={`${styles.breadcrumb} text-sm py-2`}>
          <a href="/" className="hover:underline">Trang chủ</a> / <span>Khuyến mãi</span>
        </div>

        {/* Title */}
        <h1 className={`${styles.title} text-xl md:text-2xl lg:text-3xl font-semibold text-center md:text-left py-4`}>
          Khuyến Mãi Đặc Biệt Tại EaseMart: Mua Sắm Tiết Kiệm Hơn Bao Giờ Hết!
        </h1>

        {/* Main Image */}
        <div className={`${styles.imageContainer} w-full flex justify-center`}>
          <img
            src="/assets/img/image 263.svg"
            alt="Khuyến mãi"
            className={`${styles.mainImage} w-full md:w-3/4 lg:w-1/2 object-cover`}
          />
        </div>

        {/* Description */}
        <div className={`${styles.description} max-w-3xl mx-auto text-justify py-4 space-y-4`}>
          ...
          {/* Promotion List */}
          <ul className={`${styles.promotionList} list-disc pl-5 space-y-4`}>
            <li>
