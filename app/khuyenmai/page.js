      ...
      <div className={styles.container}>
        ...
        <div className={styles.description}>
          ...
          <ul className={styles.promotionList}>
            <li>
              <strong>1. Giảm Giá Lên Đến 50% Cho Hàng Ngàn Sản Phẩm</strong>
              <br />
              Từ ngay bây giờ đến cuối tháng, bạn sẽ được giảm giá lên đến 50%
              cho các mặt hàng thiết yếu như thực phẩm, đồ uống, và đồ dùng gia
              đình.
            </li>
            <li>
              <strong>2. Mua 1 Tặng 1 Cho Sản Phẩm Hot Nhất</strong>
              <br />
              Chỉ có tại EaseMart, chương trình Mua 1 Tặng 1 cho các sản phẩm
              hot nhất hiện nay.
            </li>
            <li>
            ...
            <li>
              ...
              <br />
              Thành viên thân thiết của EaseMart sẽ nhận ngay phiếu giảm giá 10%
              cho đơn hàng đầu tiên trong ngày hôm nay!
            </li>
          </ul>

          {/* Closing Text */}
          <p>
            Còn chần chừ gì nữa? Hãy tham gia ngay cùng chúng tôi để tận hưởng
            những ưu đãi khổng lồ ngay hôm nay!
          </p>
        </div>
      </div>
    </div>
